  ...
  const poems: Poem[] = [
    {
      ...
      lines: [
        'Love is a poem that keeps on writing itself,',
        'Sweeping us along with its endless verse,',
        'I found the courage to write of the one',
        'Who is worth dying for.',
        '',
        'You deserve poetry, not fleeting lines,',
        'Nor the hollow charm of borrowed words,',
        'You taught me that love is transcendental devotion,',
        'Beyond perspectives and sense perceptions.',
        '',
        'In a world of colors masking inner chaos,',
        'You remain the truest reality I know,',
        'And though these words come with ease,',
        'My feelings resist expression beyond poetry.',
        '',
        'Perhaps when we meet in reality,',
        'I shall lose myself in a gentle trance,',
        'And when I breathe your divine scent,',
        'I shall desire only one thing:',
        '',
        'To have you kiss me back to life,',
        'So that my reality may be filled with you,',
        'Beyond imagination,',
        'And beyond my thoughts.'
      ]
    },
    {
      id: 2,
